...
def generate_model_forecast_table(fits_df, reset):
    ...
    figure = go.Figure(data=[go.Table(
        header=dict(values=list(df_table),
                ...
                align='left',
                height=30),
        cells=dict(values=[df_table['Dates'], df_table['Confirmed cases'],
                       df_table['Current forecast'], df_table['1 day ago'],
                       df_table['2 days ago'], df_table['3 days ago'],
                       df_table['4 days ago'], df_table['5 days ago'],
                       df_table['6 days ago'], df_table['7 days ago'],
                       df_table['8 days ago'], df_table['9 days ago'],
                       df_table['10 days ago']],                       
...
def update_model_forecast1(loc, model, reset_click):
    ...
    return generate_model_forecasts(loc, model, reset)
...
def update_plot_model_forecast1(df_fits, reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_model_forecast_plot(df_fits, reset)
...
def update_table_model_forecast1(df_fits, reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_model_forecast_table(df_fits, reset)
...
def update_patient_census(loc,  model, icu_beds, nonicu_beds, per_loc, per_admit, 
    ...
    df2 = generate_patient_census(loc,  model, icu_beds, nonicu_beds, per_loc, per_admit, 
    per_cc, LOS_cc, LOS_nc, per_vent, TimeLag, transfers, per_ICU_transfer, mortality, 
    GLOVE_SURGICAL, GLOVE_EXAM_NITRILE, GLOVE_EXAM_VINYL, MASK_FACE_PROC_ANTI_FOG, 
    MASK_PROC_FLUID_RESISTANT, GOWN_ISOLATION_XL_YELLOW, MASK_SURG_ANTI_FOG_FILM, 
...
def update_plot_patient_census(df_census, reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_plot_patient_census(df_census, reset)
...
def update_table_patient_census1(df_census, reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_patient_census_table(df_census, reset)
...
def update_plot_patient_discharge(df_census, reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_plot_discharge_census(df_census, reset)
...
def update_plot_ppe(df, reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_plot_ppe(df, reset)
...
def update_table_ppe(df, reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_ppe_table(df, reset)
...
def update_generate_delta_testing_plot(reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_delta_testing_plot(reset)
...
def update_generate_PopSize_vs_Tested_plot(reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_PopSize_vs_Tested(reset)
...
def update_generate_Negative_vs_Tested_plot(reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_Negative_vs_Tested(reset)
...
def update_generate_Positive_vs_Tested_plot(reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_Positive_vs_Tested(reset)
...
def update_generate_ICU_vs_Hospitalized_plot(reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_ICU_vs_Hospitalized(reset)
...
def update_generate_ventilator_vs_ICU_plot(reset_click):
    ...
    # Return to original hm(no colored annotation) by resetting
    return generate_ventilator_vs_ICU(reset)
